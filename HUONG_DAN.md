...
Nếu đây là session Cowork mới (clone repo từ máy khác), **AI phải đọc `AI_OPERATING_PROCEDURES.md` trước tiên** để kích hoạt 8 giải pháp (tiết kiệm token + bảo đảm quality):
...
**Hiệu quả:** Tiết kiệm ~30-40% tokens/session + **100% data accuracy**
